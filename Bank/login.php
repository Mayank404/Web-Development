...
<head>
    ...
    define('BANKNAME', 'SPARKS_PROJECT:MCB BANK');
...
<body style="background: url(images/Banking1.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo "MCB Bank"; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Mayank Anand</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 530px">
